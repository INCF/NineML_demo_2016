...
if config.plot_figure:
    ...
    Figure(
        ...
        Panel(data["exc"].filter(name=vm_var)[0], yticks=True, xlim=plot_limits, xticks=True),
        #Panel(data["exc"].analogsignalarrays[1], yticks=True, xlim=plot_limits),
        Panel(data["exc"].spiketrains[:100], markersize=0.5, xlim=plot_limits, xticks=True),
